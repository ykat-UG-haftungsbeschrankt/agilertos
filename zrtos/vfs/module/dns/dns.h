 ...
 */
#ifndef ZRTOS_VFS_MODULE_DNS_H
#define ZRTOS_VFS_MODULE_DNS_H
#ifdef __cplusplus
extern "C" {
#endif
...
typedef struct{
  ...
  void *arg;
}zrtos_vfs_module_dns_table_entry_t;

#define SOCKET_NONE	255
// Various flags and header field values for a DNS message
#define UDP_HEADER_SIZE	8
ZRTOS_VFS_MODULE_DNS_HEADER_SIZE	12
#define TTL_SIZE        4
#define QUERY_FLAG               (0)
