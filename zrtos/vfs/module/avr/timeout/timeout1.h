...
zrtos_error_t zrtos_vfs_module_avr_timeout1__on_open(
...
zrtos_error_t zrtos_vfs_module_avr_timeout1__on_ioctl(
	...
	switch(request){
		...
		case ZRTOS_VFS_MODULE_TIMEOUT_IOCTL__RESET:
			TCNT1 = zrtos_vfs_file__get_offset(thiz);
		break;
...
ZRTOS_VFS_PLUGIN__INIT(avr_timeout1,
	ZRTOS_VFS_PLUGIN__0_ON_OPEN(zrtos_vfs_module_avr_timeout1__on_open)
